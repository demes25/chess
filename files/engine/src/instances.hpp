...
struct EvaluableInstance : public Instance<n, p> {
    using Instance<n, p>::Instance;

    EvaluableInstance(EvaluableInstance&&) = default;
    EvaluableInstance& operator=(EvaluableInstance&&) = default;
    ~EvaluableInstance() = default;
